...
<head>
    <meta charset="UTF-8">
    <title>Riwayat Import Kandidat</title>
    <style>
        body { font-family: sans-serif; padding: 40px; background: #f8fafc; }
        .container { max-width: 1000px; margin: 0 auto; background: #fff; padding: 30px; border: 2px solid #000; }
