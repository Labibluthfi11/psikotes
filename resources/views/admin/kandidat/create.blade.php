        ...
        <form action="/admin/kandidat" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="posisi" required>
                    ...
                    @foreach(['HRGA', 'FINANCE ACCOUNTING', 'WAREHOUSE AND LOGISTIK', 'APOTEKER', 'REGULATORY AND DEVELOPMENT', 'GENERAL AFFAIR', 'SOCIAL MEDIA SPESIALIST', 'DIGITAL MARKETING', 'ADMINISTRASI PERKANTORAN', 'KONTEN KREATOR', 'DESAIGN GRAFIS', 'QUALITY CONTROL', 'STAFF FARMASI', 'IT', 'SECURITY', 'PROCURTMEN', 'PPIC', 'DATA ANALYST', 'ADMIN','OPERATOR PRODUKSI'] as $posisi)
